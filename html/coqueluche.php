...
<body>
    ...
    <section class="container">
        ...
        <section class="pagina_exame">
            ...
            <h1 class="titulo_exame" >Coqueluche</h1>

            <section class="conteudo">

                <h3>Metodologia:</h3>
                <p>
                    PCR em tempo real e Cultura em meios adequados.
                </p>    
                ...
                <p>
                    A secreção nasofaríngea é coletada introduzindo um swabultraﬁno, alginatado, na narina do paciente, até encontrar resistência na parede posterior da nasofaringe. Devem ser realizados movimentos rotatórios mantendo o swab em contato com a nasofaringe por cerca de 10 segundos.
                </p>
