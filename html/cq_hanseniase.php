    ...
    <section class="container">
        ...
        <nav class="nav_paginas">
            <ul>
                ...
                <span class="dir">></span> 
                <li>
                    <a href="#">Controle Externo de Qualidade de Hanseníase</a>
                </li>
            </ul>
        </nav>
        ...
        <section class="pagina_exame">
            ...
            <h1 class="titulo_exame" >Controle Externo de Qualidade de Hanseníase</h1>
            ...
            <section class="conteudo">
                ...
                <h3>Metodologia:</h3>
                <p>
                    Releitura das lâminas de baciloscopia realizadas nos Laboratório Regionais e Municipais que realizam baciloscopia para Hanseníase.
                </p>    
                <h3>Descrição:</h3>
                <p>
                ...
                <h3>Amostras:</h3>
                <p>
                    Lâminas de baciloscopia utilizadas no diagnóstico e controle da Hanseníase.
                </p>    
                <h3>Acondicionamento e transporte:</h3>
                <p>
