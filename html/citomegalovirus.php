...
<body>
    ...
    <section class="container">
        ...
        <section class="pagina_exame">
            ...
            <h1 class="titulo_exame" >Citomegalovírus (CMV)</h1>

            <section class="conteudo">

                <h3>Metodologia:</h3>
                <p>
                    Sorologia: pesquisa de anticorpos por ensaios imunoenzimáticos e/ou quimioluminescência/ eletroquimioluminescência;<br>
                    PCR em tempo real.
                </p>   
                <h3>Amostra biológica:</h3>
                <p>
                    Soro;<br>
                    Urina (PCR em tempo real).
                </p>    
                <h3>Volume ideal:</h3>
                <p>
                ...
                <p>
                    Soro: Coleta por punção venosa (mínimo de 5ml de sangue) em tubo sem anticoagulante. Após a coleta realizar a centrifugação da amostra para separação do soro.<br>
                    Urina: NAO INFORMADO
                </p>
                ...
                <p>
                    ...
                    Usar suporte ou estante adequada para colocar os tubos de ensaio ou microtubos, a ﬁm de evitar derramamento ou vazamento das amostras durante o transporte, forrar a caixa térmica com papel absorvente (tipo toalha de papel descartável).
                </p>
                <h3>Formulários requeridos:</h3>
                <p>
                    Todo material enviado ao LACEN-PE, deve ser acompanhado da ﬁcha de solicitação do exame totalmente preenchida, conforme modelo disponível na Recepção de Amostras Biológicasdo LACEN/PE.
                </p>
