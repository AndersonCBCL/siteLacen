...
<body>
    ...
    <section class="container">
        ...
        <section class="pagina_exame">
            ...
            <h1 class="titulo_exame" >Toxoplasmose</h1>

            <section class="conteudo">

                <h3>Metodologia:</h3>
                <p>
                    Eletroquimioluminescência (ECLIA); pesquisa qualitativa e quantitativa dos anticorpos aglutinantes das classes IgG, IgM e dosagem de anticorpos de Avidez.
                </p>    
                ...
                <p>
                    As amostras clínicas devem ser coletadas entre o 7º ao 14º dia do início dos sintomas e/ou durante a gestação, como investigação de toxoplasmose congênita
                </p>
                ...
                <p>
                    Soro: 2 a 8°C (até 24h); -20°C por até 15 dias.
                </p>
                ...
                <p>
                    ...
                    São critérios de rejeição: amostras hemolisadas, soros hiperlipêmicos, acondicionamento adequado, volume insuficiente, amostra em temperatura ambiente ou com identificação inadequada.
                </p>
            </section>
        </section>
    </section>
