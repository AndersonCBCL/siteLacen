...
<body>
    ...
    <section class="container">
        ...
        <section class="pagina_exame">
            ...
            <h1 class="titulo_exame" >Adenovírus</h1>
            ...
            <section class="conteudo">
                ...
                <p>
                    <ul>
                        <li>Swab de Nasofaringe;</li>
                        <li>Aspirado de Nasofaringe;</li>
                        <li>Aspirado Traqueal e Lavado Broncoalveolar.</li>
                        <li>Para amostras de SVO, as vísceras devem ser encaminhadas congeladas; não podem, sob hipótese alguma, ser colocadas em formol.</li>
                    </ul>
                </p>
                <h3>Volume ideal:</h3>
                <p>
                ...
                <p>
                    Para casos suspeitos de Síndrome Respiratória Aguda Grave (SRAG Hospitalizado), clique aqui (https://sivepgripe.saude.gov.br/sivepgripe);<br>
                    Para casos suspeitos de Síndrome Gripal (SG), clique aqui (https://notifica.saude.gov.br/onboard).
                </p>
