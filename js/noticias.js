...
function exibirNoticias() {
    ...
    noticiasExibir.forEach((noticia, index) => {
        ...
        <div class="news-text">
            <h2 id="${noticia.id}">
                <a class="news-link" href="${noticia.link}">${noticia.titulo}</a>
            </h2>
...
export const noticias = [
    { titulo: "Teste 1 Lorem ipsum dolor sit amet conscectur adispiscing elit", descricao: "Descrição 1 Lorem ipsum dolor sit amet conscectur adispiscing elit", data: "30/01/2025", imagem: "", link:"../arquivos/qualidade/nvl/Boletim_NVL_Dezembro_2024_ok.pdf", id: "noticia_1" },
    { titulo: "Teste 2 Lorem ipsum dolor sit amet conscectur adispiscing elit", descricao: "Descrição 2 Lorem ipsum dolor sit amet conscectur adispiscing elit", data: "29/01/2025", imagem: "../imagens/ultimas-noticias/lacen-img1.jpg", link:"../arquivos/qualidade/nvl/Para configurar um servidor com RAID 6.html", id: "noticia_2" },
